...
from .common.utils import get_embedding_models, get_qdrant_client, get_openai_client, parse_natural_date
...
def context_change(workspace: dict, product_type: str):
        # 4. 내부 제품 데이터 검색
